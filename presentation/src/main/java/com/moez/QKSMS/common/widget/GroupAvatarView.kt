...
import com.fulldive.extension.divesms.databinding.GroupAvatarViewBinding

class GroupAvatarView @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null
) : ConstraintLayout(context, attrs) {

    private val binding = GroupAvatarViewBinding.inflate(LayoutInflater.from(context), this)
