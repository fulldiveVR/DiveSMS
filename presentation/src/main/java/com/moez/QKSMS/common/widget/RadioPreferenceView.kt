...
import com.fulldive.extension.divesms.databinding.RadioPreferenceViewBinding
...
class RadioPreferenceView @JvmOverloads constructor(
    ...
    val binding = RadioPreferenceViewBinding.inflate(LayoutInflater.from(context), this)
