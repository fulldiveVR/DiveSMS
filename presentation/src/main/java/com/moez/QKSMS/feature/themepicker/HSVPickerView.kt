...
import com.fulldive.extension.divesms.databinding.HsvPickerViewBinding
...
class HSVPickerView @JvmOverloads constructor(
    ...
    private val binding = HsvPickerViewBinding.inflate(LayoutInflater.from(context), this)
