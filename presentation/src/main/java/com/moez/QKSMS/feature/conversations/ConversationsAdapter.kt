...
import com.fulldive.extension.divesms.databinding.ConversationListItemBinding
...
class ConversationsAdapter @Inject constructor(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): QkViewHolder {
        val binding = ConversationListItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
