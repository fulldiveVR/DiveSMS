...
import com.fulldive.extension.divesms.databinding.QksmsPlusActivityBinding
...
class PlusActivity : QkThemedActivity(), PlusView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.linearLayout.children
                ...
                .map { it.findViewById<QkTextView>(R.id.titleView) }
                .forEach { it.setTypeface(it.typeface, Typeface.BOLD) }

        val textPrimary = resolveThemeColor(android.R.attr.textColorPrimary)
        binding.collapsingToolbar.collapsingToolbar.setCollapsedTitleTextColor(textPrimary)
        binding.collapsingToolbar.collapsingToolbar.setExpandedTitleColor(textPrimary)
